...
NGQModule = tslib_1.__decorate([
    core_1.NgModule({
        ...
        providers: [
            ...
            register_widget_1.registerWidget('View', () => require('@ngq/core/view').ViewWidget),
            register_widget_1.registerWidget('Image', () => require('@ngq/core/image').ImageWidget),
        ],
...
//# sourceMappingURL=ngq.module.js.map